...
public class EgeTaskController {
	...
	@GetMapping
	public ResponseEntity<Page<EgeTaskDto>> findAll(@RequestParam(required = false) Integer egeNumber,
			@RequestParam(required = false) String topics, @RequestParam(required = false) String difficulty,
